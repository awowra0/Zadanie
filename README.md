...
1. Uruchomienie funkcji tworzącej bazę danych lub ręczne założenie lokalej bazy danych "db_prod" na SQL Server.
...
Wymagany jest posiadanie lokalnego serwera na SQL Server.  
